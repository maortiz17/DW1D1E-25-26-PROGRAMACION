package es.maos17.cdr.programacion.ut07.ejemplos.ejemplo01dependencia;
...
public class Programa2 {
	...
	public static void main(String[] args) {
		// Composición de la clase java.util.Scanner, porque creamos un objeto
		// (atributo) de esa clase. Dependencia de la clase java.io.InputStream, porque
		// usamos System.in,
