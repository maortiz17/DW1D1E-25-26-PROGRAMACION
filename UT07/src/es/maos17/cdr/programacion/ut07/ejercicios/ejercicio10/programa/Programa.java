package es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.programa;

import java.util.Random;

import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Circulo;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Cuadrado;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Elipse;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Figura;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.PoligonoRegular;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Rectangulo;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Rombo;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Romboide;
import es.maos17.cdr.programacion.ut07.ejercicios.ejercicio10.clases.Triangulo;
...
//		} while (!((ladoA < (ladoB + ladoC)) && (ladoB < (ladoA + ladoC)) && (ladoC < (ladoA + ladoB))));
	...
	private static void mostrarFiguras(Figura[] figuras) {
		for (int i = 0; i < figuras.length; i++) {
			...
			System.out.printf("La figura en la posición %d es '%s', su área es %.2f, su perímetro es %.2f y tiene %d lados\n", i+1,
					getTipoFigura(figura), figura.area(), figura.perimetro(), figura.getNumLados());
		}
	}
}
