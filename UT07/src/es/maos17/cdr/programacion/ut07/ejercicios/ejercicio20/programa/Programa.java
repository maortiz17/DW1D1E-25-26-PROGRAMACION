package es.maos17.cdr.programacion.ut07.ejercicios.ejercicio20.programa;
...
private static void mostrarFiguras(Escalable[] figuras) {
	for (int i = 0; i < figuras.length; i++) {
		Figura figura = (Figura)figuras[i];
