...
public class Ejercicio03_04_10 {

	public static void main(String[] args) {
		/**
		 * 
		 * Crea un método invertirCadena que: • Recibe una cadena como parámetro •
		 ...
		 * Si la cadena es null, devuelve null. Ejemplo: invertirCadena(“murciélago”)
		 * devolvería “ogaléicrum”.
		 *
		 */
